...
public:
   ...
   void onClose ()
   {
      ...
      if (m_pIControl != NULL)
         m_pIControl->SocketDisconnect_Complete ((int)RMAP::CORE::CLIENT::SetVDParam (m_bVoluntary, false, m_bDisconnected));
...
void NET::connection_metadata::on_open (client* c, websocketpp::connection_hdl hdl)
{
   ...
   m_pImpl->m_pIControl->SocketConnect_Complete ((int)RMAP::CORE::CLIENT::SetVDParam (m_pImpl->m_bVoluntary, true, false));
